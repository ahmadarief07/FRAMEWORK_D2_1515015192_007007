			...
			<div class="navbar-header">
				...
				<ul class="nav navbar-nav">
					<li class="dropdown active">
						<a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Mahasiswa <span class="caret">
						</span></a>
				<ul class="dropdown-menu" aria-labelledby="dLabel">
					<li><a href="{{url(''mahasiswa)}}">Data Mahasiswa</a></li>
					<li class="divider"></li>
					<li><a href="{{url('jadwal_matakuliah')}}">Jadwal Matakuliah</a></li></ul>
					</li>
					<li class="dropdown active">
						...
						<li class="divider"></li>
						<li><a href="{{url('dosen_matakuliah')}}">Jadwal Dosen Mengajar</a></li></ul></li>

					<li class="dropdown active">
						<a href='#' data-toggle="dropdown" role="button" aria-haspopup="true" aria=false""> Penagaturan <span class="caret"></span></a>
						<ul class="dropdown-menu" aria-labelledly="dLabel">
						<li><a href="{{url('pengguna')}}">Pengguna</a></li>
						<li class="divider"></li>
						<li><a href="{{url('ruangan')}}">Ruangan</a></li>
						<li><a href="{{url('matakuliah')}}">Ruangan</a></li>
						</ul>
					</li>
				</ul>
			</div><!--/.nav-collapse-->
